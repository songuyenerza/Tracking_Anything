...
if __name__ == "__main__":
    ...
    print("dict_box_merge ==", dict_box_merge.keys())
    exit()
        ...
        if cout_data in frame_ids.keys():
            ...
            for id in objs_frame.keys():
                ...
                for i, box_normalized in enumerate(list_box_merge):
                    ...
                    img_path = os.path.join("./video_output_1204/0505/output_tach_box_2004008_01_PXL_20230125_223312522/", str(img_name_merge))
